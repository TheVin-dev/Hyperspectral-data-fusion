function [MOVINGREG] = registerImages2b1inv(MOVING,FIXED)
...
% Auto-generated by registrationEstimator app on 16-Dec-2021
%-----------------------------------------------------------
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',43.125000,'MaxRatio',0.431250);
...
[tform,inlieridx] = estimateGeometricTransform2D(movingMatchedPoints,fixedMatchedPoints,'similarity');
